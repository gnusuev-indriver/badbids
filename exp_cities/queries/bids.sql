DECLARE city_id INT64 DEFAULT 1234; -- Укажите нужный city_id
DECLARE type_name STRING DEFAULT 'TAXI'; -- Укажите нужный type_name
DECLARE start_date DATE DEFAULT DATE '2024-01-01'; -- Укажите нужную начальную дату
DECLARE stop_date DATE DEFAULT DATE '2024-01-31'; -- Укажите нужную конечную дату
DECLARE pickup_eta_minutes INT64 DEFAULT 5; -- Укажите нужное значение pickup_eta_minutes
