...
def plot_prices_by_time(df_grouped, grouped_column, plot_root_path, is_before=True, is_show=True):
    ...
    if is_before:
        fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'Before'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'Before']['rides_price_highrate_usd'],
                             mode='lines',
                             name='rides_price_highrate_usd (Before)',
                             line=dict(color='#2CA02C', width=2, dash='dot')),
                  row=1, col=1)
    fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'Control'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'Control']['rides_price_highrate_usd'],
                             mode='lines',
                             name='rides_price_highrate_usd (Control)',
                             line=dict(color='#2CA02C', width=2, dash='dash')),
                  row=1, col=1)
    fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'A'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'A']['rides_price_highrate_usd'],
                             mode='lines',
                             name='rides_price_highrate_usd (A)',
                             line=dict(color='#1C8356', width=2, dash='solid')),
                  row=1, col=1)
    if is_before:
        fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'Before'][grouped_column], 
    ...
    if is_before:
        fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'Before'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'Before']['rides_price_start_usd'],
                             mode='lines',
                             name='rides_price_start_usd (Before)',
                             line=dict(color='#EECA3B', width=2, dash='dot')),
                  row=1, col=1)
    fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'Control'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'Control']['rides_price_start_usd'],
                             mode='lines',
                             name='rides_price_start_usd (Control)',
                             line=dict(color='#EECA3B', width=2, dash='dash')),
                  row=1, col=1)
    fig.add_trace(go.Scatter(x=df_grouped[df_grouped.group_name == 'A'][grouped_column], 
                             y=df_grouped[df_grouped.group_name == 'A']['rides_price_start_usd'],
                             mode='lines',
                             name='rides_price_start_usd (A)',
